...
⚠️ Check the [LICENSE](LICENSE) file for the code and [MODEL_LICENSE](MODEL_LICENSE) for the models before using or distributing them. The models included in this repository are licensed **for research purposes only**.  Any commercial, clinical, diagnostic, or paid product use is prohibited without a separate agreement with the rights holder. Please [cite this repository](#how-to-cite) and the original study if the models are modified or used in publications.
...
|----------|--------|--------------------|--------------------|
| Synthetic CT | Brain | Zaffino et al., Toward Closing the Loop in Image-to-Image Conversion in Radiotherapy: A Quality Control Tool to Predict Synthetic Computed Tomography Hounsfield Unit Accuracy | [Read more](https://www.mdpi.com/2313-433X/10/12/316) |


### How to Integrate a Custom Model

The integration process is the **same [procedure](#how-to-integrate-a-custom-model) as for ModalityConverter**, but you should implement it in the SyntheticImageQualityAssurance module.
