...
#
# SyntheticImageQualityAssurance
#


class SyntheticImageQualityAssurance(ScriptedLoadableModule):
...
#
# SyntheticImageQualityAssuranceParameterNode
#


@parameterNodeWrapper
class SyntheticImageQualityAssuranceParameterNode:
    inputVolume: vtkMRMLScalarVolumeNode
    maskVolume: vtkMRMLScalarVolumeNode
    outputVolume: vtkMRMLScalarVolumeNode

#
# SyntheticImageQualityAssuranceWidget
#


class SyntheticImageQualityAssuranceWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def onHelpButtonClicked(self):
        from SyntheticImageQualityAssuranceLib.UI.HelpDialog import HelpDialog
    ...
    def setup(self) -> None:
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath("UI/SyntheticImageQualityAssurance.ui"))
        ...
        self.logic = SyntheticImageQualityAssuranceLogic()
    ...
    def setParameterNode(self, inputParameterNode: Optional[SyntheticImageQualityAssuranceParameterNode]) -> None:
        """
...
#
# SyntheticImageQualityAssuranceLogic
#

class SyntheticImageQualityAssuranceLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return SyntheticImageQualityAssuranceParameterNode(super().getParameterNode())

    def getModelInstance(self, selectedModelModuleName, selectedModelKey, basePackage="SyntheticImageQualityAssuranceLib.ModelsImpl", device="cpu"):
        """
        ...
        - basePackage (str): The base package path where the model modules are located. Defaults to "SyntheticImageQualityAssuranceLib.ModelsImpl".
        ...
        import importlib
        from SyntheticImageQualityAssuranceLib.ModelBase import MODEL_REGISTRY
